const adSelectors = [
    ...
    ".content-id-lcWiqrokCn0 > a:nth-child(2) > yt-thumbnail-view-model:nth-child(1) > div:nth-child(1) > img:nth-child(1)",
    "#contents > ytd-rich-grid-renderer:nth-child(2) > div:nth-child(4) > ytd-rich-grid-row:nth-child(1) > div:nth-child(1) > ytd-rich-item-renderer:nth-child(2) > div:nth-child(1) > ytd-video-renderer:nth-child(1) > div:nth-child(1) > div:nth-child(1) > ytd-thumbnail:nth-child(1) > yt-img-shadow:nth-child(1) > img:nth-child(1)",
    "#contents > ytd-rich-grid-renderer:nth-child(2) > div:nth-child(4) > ytd-rich-grid-row:nth-child(1) > div:nth-child(1) > ytd-rich-item-renderer:nth-child(2) > div:nth-child(1) > ytd-video-renderer:nth-child(1) > div:nth-child(1) > div:nth-child(1) > ytd-thumbnail:nth-child(1) > yt-img-shadow:nth-child(1) > img:nth-child(1)",
    "#AdContainer",
    "#AdMiddle",
    "#RadAd_Skyscraper",
    ...
    "[id^=\"dclkAds\"]",
    "[id^=\"konaLayer\"]",
    "a.kLink span[id^=\"preLoadWrap\"][class=\"preLoadWrap\"]",
    "div[id=\"tooltipbox\"][class^=\"itxt\"]",
    "div[id^=\"google_ads_div\"]",
    "embed[flashvars*=\"AdID\"]",
    "iframe[id=\"dapIfM0\"]",
    "iframe[name^=\"AdBrite\"]",
    "iframe[src*=\"clicksor.com\"]",
    "img[src*=\"clicksor.com\"]",
    "ispan#ab_pointer",
    "#A9AdsMiddleBoxTop",
    ...
    ".topAds",
    ".top_ads",
    "#adt[align=\"right\"][style=\"border-left: 1px solid rgb(201, 215, 241);\"]",
    "#mbEnd[cellspacing=\"0\"][style=\"padding: 0pt; white-space: nowrap;\"]",
    "#mbEnd[width=\"30%\"][style]",
    "#mboxEnd[width=\"30%\"][style]",
    "div#mclip_container:first-child:last-child",
    "div#tads.c",
    "div.ch[id^=\"tba\"][style]",
    "div.ch[id^=\"tpa\"][style]",
    "div[style=\"font-size: small; background-color: rgb(255, 249, 221);\"]",
    "div[style^=\"background: rgb(255, 248, 221) none repeat scroll 0% 0%; margin-top: 10px;\"]",
    "table.ra[align=\"left\"][width=\"30%\"]",
    "table.ra[align=\"right\"][width=\"30%\"]",
    "table[align=\"center\"][cellpadding=\"0\"][style*=\"padding: 8px;\"][style*=\"rgb(255, 248, 221);\"][width=\"100%\"]",
    "table[style=\"background: none repeat scroll 0% 0% rgb(255, 248, 231); padding: 8px; margin-top: 0px;\"]",
    "table[style^=\"padding: 8px; background: rgb(255, 248, 221) none repeat scroll 0% 0%; -moz-background-clip:\"]"
];
